package com.wedrive.android.traffic.utils;
...
/**
 * Created by wangwg on 2016/2/26.
 */
public class LogUtils {
    ...
    public static void init(Context context, boolean logSwitch, boolean log2FileSwitch, char logFilter, String tag, String dir) {
        LogUtils.dir = dir + File.separator;
        LogUtils.logSwitch = logSwitch;
        LogUtils.log2FileSwitch = log2FileSwitch;
        LogUtils.logFilter = logFilter;
        LogUtils.tag = tag;
...
//            tag = LogUtils.tag + "::" + tag;
    ...
    private synchronized static void log2File(char type, String tag, String content) {
        ...
        try {
            ...
            raf.write((dateLogContent).getBytes());
            raf.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
